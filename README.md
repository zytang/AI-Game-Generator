...
[![Gemini](https://img.shields.io/badge/AI-Gemini_1.5_Flash-blue.svg)](https://deepmind.google/technologies/gemini/)
...
The system uses FastAPI (Python) and Google Gemini 1.5 Flash to create self-contained artifacts that run instantly in any browser.
...
✅ **Gemini 1.5 Flash Integration**: Optimized for the latest model to provide faster generation and improved logic.
...
│   ├── gemini_client.py     # Gemini 1.5 API integration
